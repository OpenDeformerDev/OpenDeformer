...
namespace ODER {
	...
	public:
		...
		void addExternalDampingForceMatrix(const StaDampingForcer& forcer);
	...
	template<class SpMatrix> void NonlinearImplicitBackwardEuler<SpMatrix>::addExternalDampingForceMatrix(const StaDampingForcer& forcer) {
